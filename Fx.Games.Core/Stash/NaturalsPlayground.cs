namespace Stash
{
    ...
    public static class NaturalsPlayground
    {
            ...
            where TMinimum : TNatural
        {
            ...
            protected internal override TResult Accept(StartingSegment<TMinimum, TMaximum, Func<TNode, TContext, TResult>, TNatural> node, (TNode Node, TContext Context) context)
            {
