namespace Fx.Games.Strategy
{
    ...
    public sealed class MonteCarloStrategySettings<TGame, TBoard, TMove, TPlayer, TDistribution> where TGame : IGame<TGame, TBoard, TMove, TPlayer, TDistribution> where TDistribution : IDistribution<TGame>
    {
        /// <summary>
        ...
        /// </summary>
        public static MonteCarloStrategySettings<TGame, TBoard, TMove, TPlayer, TDistribution> Default { get; } = new MonteCarloStrategySettings<TGame, TBoard, TMove, TPlayer, TDistribution>(EqualityComparer<TPlayer>.Default, new Random());
        ...
        public sealed class Builder
        {
            ...
            /// A <see cref="IEqualityComparer{T}"/> that compares players of the game
            /// </summary>
            public IEqualityComparer<TPlayer> PlayerComparer { get; set; } = MonteCarloStrategySettings<TGame, TBoard, TMove, TPlayer, TDistribution>.Default.PlayerComparer;

            /// <summary>
            /// The distribution to use when selecting random moves when the strategy simulates a game
            /// </summary>
            public Random Random { get; set; } = MonteCarloStrategySettings<TGame, TBoard, TMove, TPlayer, TDistribution>.Default.Random;
            ...
            public MonteCarloStrategySettings<TGame, TBoard, TMove, TPlayer, TDistribution> Build()
            {
                ...
                return new MonteCarloStrategySettings<TGame, TBoard, TMove, TPlayer, TDistribution>(this.PlayerComparer, this.Random);
            }
        }
    }
}
