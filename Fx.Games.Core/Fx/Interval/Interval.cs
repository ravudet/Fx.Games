...
#pragma warning restore anidTODO // Type or member is obsolete
        ...
        public static Interval<TMinimum, TIntermediate, TNumeric, TValue>.Partition<TMaximum, TSubInterval> Partition<TMinimum, TIntermediate, TNumeric, TValue, TMaximum, TSubInterval>(TSubInterval subInterval, TMaximum maximum, TValue value)
            where TMinimum : TNumeric
...
#pragma warning disable anotheridTODO // Type or member is obsolete
            return new Interval<TMinimum, TIntermediate, TNumeric, TValue>.Partition<TMaximum, TSubInterval>(subInterval, maximum, value);
